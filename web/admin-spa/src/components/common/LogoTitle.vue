<template>
  <div class="flex items-center gap-4">
    <!-- Logo区域 -->
    <div
      class="flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border border-gray-300/30 bg-gradient-to-br from-sky-400/20 to-pink-400/20 backdrop-blur-sm dark:border-gray-600/30 dark:from-sky-500/20 dark:to-pink-500/20"
    >
